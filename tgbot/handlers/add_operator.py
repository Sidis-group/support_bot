...
async def make_add_admin_markup(call: CallbackQuery):
    await call.answer()
    await call.message.edit_text(
        ...
        reply_markup=inline.markup_after_creating_link
    )
...
async def add_new_operator(message: Message, config: Config, messages: schemas.Messages):
